			...
			<form class="table-box-type-1" method="POST" action="../article/doModify">
				...
				<table>
					...
					<tbody>
						...
						<tr>
							<th>제목</th>
							<td><textarea class="w-full text-black" name="body" rows="1">${article.body}</textarea>
							</td>
						</tr>
						<tr>
							<th>내용</th>
							<td><textarea class="w-full text-black" name="body"
									rows="10">${article.body}</textarea></td>
						</tr>
						<tr>
							<th>수정</th>
